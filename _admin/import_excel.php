...
for ($i = 1; $i <= 8; $i++) {
	if(!$stock_ref_label_found){
		...
		for ($ii=1; $ii<=5; $ii++){
			...
			if((strpos($searchforRow_LabelofLotID,'lotid') !== false) || (strpos($searchforRow_LabelofLotID,'lot id') !== false) || ((strpos($searchforRow_LabelofLotID,'stock') !== false) && (strpos($searchforRow_LabelofLotID,'ref') !== false))){
