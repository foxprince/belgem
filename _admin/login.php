...
<p style='text-align:center;'><img src="../images/belgemlogo.png" style="width:128px;" /></p>
<h1 style="margin-top:20px; text-align:center; color:#FFF;">比利时BELGEM钻石公司<br />国际钻石交易平台</h1>
<?php
...
<form id="loginform" method="post" action="">
    ...
    <p style="text-align:center;">
        ...
        <input type="text" name="login" id="login" placeholder="用户名"><br />
