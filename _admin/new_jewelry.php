...
if(isset($_POST['category']) && isset($_POST['name_ch'])){
	...
	$sql_insert='INSERT INTO jewelry (category, name_en, name_ch, image1, image2, image3, image4, image5, image6, image7, image8, videolink, text_en, text_ch) 
	VALUES(:category, :name_en, :name_ch, :image1, :image2, :image3, :image4, :image5, :image6, :image7, :image8, :videolink, :text_en, :text_ch)';
