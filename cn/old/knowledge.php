...
$sql_element='SELECT knowledgeimage FROM settings';
...
<h3 class="blocktitle">利美钻石 : 钻石知识</h3>

<img class="sidevisual" src="<?php echo $pic['knowledgeimage']; ?>" />
...
if(isset($totalpages) && $totalpages>1){
	...
	?>
	<a class="articlepagelinker" href="knowledge.php?p=<?php echo $i; ?>"><?php echo $i; ?></a>
	<?php
	}
}
?>
