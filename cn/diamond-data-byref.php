...
<tr id="visiable-<?php echo $row['stock_ref']; ?>" class="<?php echo $r; ?> valueline sourse_<?php echo $row['source']; ?>" title="<?php echo $row['stock_ref']; ?>">
...
<button class="deleterulesbtn" onclick="removeFromSession('<?php echo $row['stock_ref']; ?>')" >取消</button>
</td>
